...
func (x *SendFriendRequestReq) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (x *SendFriendRequestReq) GetToId() int64 {
	if x != nil {
		return x.ToId
	}
	return 0
...
func (x *ListFriendsRequest) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
type ListFriendsResponse struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	Friends       []*UserItem            `protobuf:"bytes,1,rep,name=friends,proto3" json:"friends,omitempty"`
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
...
func (x *ListFriendsResponse) GetFriends() []*UserItem {
	if x != nil {
		return x.Friends
	}
	return nil
...
func (x *FriendRequestItem) GetFromId() int64 {
	if x != nil {
		return x.FromId
	}
	return 0
...
func (x *FriendRequestItem) GetFromUsername() string {
	if x != nil {
		return x.FromUsername
	}
	return ""
...
func (x *ListFriendRequestsRequest) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
const file_proto_im_proto_rawDesc = "" +
	...
	"\fKickResponse\"A\n" +
	"\x14SendFriendRequestReq\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\x12\x13\n" +
	"\x05to_id\x18\x02 \x01(\x03R\x04toId\"\x17\n" +
	"\x15SendFriendRequestResp\"e\n" +
	"\x16HandleFriendRequestReq\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\x12\x1d\n" +
	"\n" +
	"request_id\x18\x02 \x01(\x03R\trequestId\x12\x16\n" +
	"\x06accept\x18\x03 \x01(\bR\x06accept\"\x19\n" +
	"\x17HandleFriendRequestResp\"*\n" +
	"\x12ListFriendsRequest\x12\x14\n" +
	"\x05token\x18\x01 \x01(\tR\x05token\"=\n" +
	"\x13ListFriendsResponse\x12&\n" +
	"\afriends\x18\x01 \x03(\v2\f.im.UserItemR\afriends\"\x98\x01\n" +
	"\x11FriendRequestItem\x12\x0e\n" +
	"\x02id\x18\x01 \x01(\x03R\x02id\x12\x17\n" +
	"\afrom_id\x18\x02 \x01(\x03R\x06fromId\x12#\n" +
	...
	"\tListUsers\x12\x14.im.ListUsersRequest\x1a\x15.im.ListUsersResponse\x12H\n" +
...
var file_proto_im_proto_goTypes = []any{
	...
	(*SendFriendRequestReq)(nil),       // 23: im.SendFriendRequestReq
	(*SendFriendRequestResp)(nil),      // 24: im.SendFriendRequestResp
	(*HandleFriendRequestReq)(nil),     // 25: im.HandleFriendRequestReq
	(*HandleFriendRequestResp)(nil),    // 26: im.HandleFriendRequestResp
	(*ListFriendsRequest)(nil),         // 27: im.ListFriendsRequest
	(*ListFriendsResponse)(nil),        // 28: im.ListFriendsResponse
...
var file_proto_im_proto_depIdxs = []int32{
	...
	2,  // 9: im.LogicService.Sync:input_type -> im.SyncRequest
	10, // 10: im.LogicService.CreateGroup:input_type -> im.CreateGroupRequest
	12, // 11: im.LogicService.CreateDM:input_type -> im.CreateDMRequest
	16, // 12: im.LogicService.MarkRead:input_type -> im.MarkReadRequest
	18, // 13: im.LogicService.ListUsers:input_type -> im.ListUsersRequest
	23, // 14: im.LogicService.SendFriendRequest:input_type -> im.SendFriendRequestReq
